          ...
          {!loading && events.length > 0 && viewMode === 'list' && (
            <div className="space-y-6">
              {groupEventsByDate().map(([date, dayEvents]) => (
                ...
                >
                  <div className="bg-gradient-to-r from-primary-600 to-accent-500 p-4">
                  ...
                  <div className="p-4 space-y-3">
                    {dayEvents.map((event) => (
                      <div
                        key={event._id}
                        className="flex items-start gap-4 p-4 rounded-xl border-2 hover:border-primary-300 transition-colors"
                        style={{
